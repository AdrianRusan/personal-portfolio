  ...
  return (
    ...
    >
      <div
        ...
        className="absolute md:left-1/2 top-1/2 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2"
      >
        <div
          style={{
            transform: transform,
        ...
        >
          <div className={cn(" relative z-50 flex flex-col items-center justify-center", className)}>{children}</div>
        </div>
      </div>
    </div>
  );
